...
import { MapPin, User, BarChart3, Crown } from "lucide-react"
          ...
          <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-3">
              ...
              <div className="bg-background border border-border rounded-lg p-4 hover:border-accent hover:shadow-md transition-all group cursor-pointer">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">{t("comparator.subtitle")}</p>
                  </div>
            ...
            <Link href="/premium">
              <div className="bg-gradient-to-r from-amber-500/10 to-yellow-500/10 border border-amber-500/30 rounded-lg p-4 hover:border-amber-500 hover:shadow-md transition-all group cursor-pointer">
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="text-base font-bold mb-0.5 group-hover:text-amber-600 transition-colors">
                      {t("nav.premium")}
                    </h3>
                    <p className="text-xs text-muted-foreground">{t("premium.features")}</p>
                  </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2">
              <div className="mb-6">
                <h3 className="text-xl font-display font-bold mb-1">{t("home.teams.title")}</h3>
                <p className="text-sm text-muted-foreground">{t("home.teams.subtitle")}</p>
              </div>
